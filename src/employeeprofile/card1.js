...
function Template() {
  ...
  return (
    ...
    <Container  >
        <h4 style={{ marginLeft: "-90px", marginTop: "100px" }}>Profile</h4>
        <h5 style={{ marginTop: "0px", marginLeft: "-90px", fontSize: "17px" }}>Dashboard / profile</h5>
      </Container>
    ...
    <Row xs={1} md={2} className="g-0 mt-2 px-3" style={{marginLeft:"0px",marginRight:"20px" }}>
  ...
  style={{
    ...
    borderRadius:"40px"// Adjust the top position according to your needs
      ...
      <Col  className='noborder' style={{width:"600px"}} >
        <Card className='noborder' style={{height:"224px",width:"747px"}} >
