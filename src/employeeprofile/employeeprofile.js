        ...
        <Container >
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="justify-content-end ms-auto">
              ...
              <RiNotification2Line  id="icon" className="notification ms-sm-2, mt-lg-0" style={{ marginTop: '10px' }} size={20} />
              <h6>
                <Badge bg="primary" style={{ marginTop: "20px", marginRight: "20px" }} >3</Badge>
              </h6>

              <RiChat1Line    id="icon" className="comment ms-sm-2, mt-lg-0" style={{ marginRight: "-3px", marginTop: "10px", fontSize: "20px" }} size={20} />
              <h6>
